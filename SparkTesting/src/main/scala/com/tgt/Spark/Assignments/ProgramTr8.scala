...
object ProgramTr8 {
 ...
 def main(args: Array[String]){
    ...
    println("initial partition count	: "+  rdd.partitions.length)

    val reparRdd = rdd.repartition(4)
    println("re-partition count			:"+  reparRdd.partitions.length)
    ...
    println("Checking for words starting with a ")
    ...
    rdd5.saveAsTextFile("C:/Users/CSC/git/SparkTesting/SparkTesting/Files/Output")
